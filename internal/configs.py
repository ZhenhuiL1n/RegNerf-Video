...
class Config:
  ...
  blender_scene: str = 'pop-sparse'  # Which blender scene to use.
  ...
  checkpoint_every: int = 3000  # The number of steps to save a checkpoint.
  print_every: int = 100  # The number of steps between reports to tensorboard.
  train_render_every: int = 5000  # Steps between test set renders for training
